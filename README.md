# Conductores_CorredoresPuntos
## Captura

![imagen](https://github.com/user-attachments/assets/5b885f07-71c1-4ed0-ad4e-4c190f29c3b3)
...
public class Main {
    ...
    private void connectDB() {
        try {
            String url = "jdbc:postgresql://localhost:5432/Corredores1";
